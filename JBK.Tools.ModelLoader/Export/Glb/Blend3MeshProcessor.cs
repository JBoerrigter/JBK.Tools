...
public class Blend3MeshProcessor : IMeshProcessor
{
    public IMeshBuilder<MaterialBuilder> Process(IIndexProcessor indexProcessor, MaterialBuilder material, Mesh mesh)
    {
        ...
        var vertices = GetVertexBuilders(mesh.BoneIndices, mesh.Vertecies.OfType<VertexBlend3>().ToArray());
    ...
    public IVertexBuilder[] GetVertexBuilders(byte[] palette, VertexBlend3[] vertices)
    {
        ...
        for (int i = 0; i < vertices.Length; i++)
        {
            ...
            vertexBuilders[i] = new VertexBuilder<VertexPositionNormal, VertexTexture1, VertexJoints4>(
                ...
                new VertexJoints4(
                    ...
                    (palette[idx2], vertices[i].GetBlendWeight2())
                ));
        }
